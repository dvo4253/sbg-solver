...
from test.state.moves.master._1x1.middle.top_middle_moveUp_assert import getMoves as _1x1_middle_middle_moveUp_assert_getMoves
from test.state.moves.master._1x1.middle.top_middle_moveLeft_assert import getMoves as _1x1_middle_middle_moveLeft_assert_getMoves
from test.state.moves.master._1x1.middle.top_middle_moveRight_assert import getMoves as _1x1_middle_middle_moveRight_assert_getMoves
from test.state.moves.master._1x1.middle.top_middle_moveDown_assert import getMoves as _1x1_middle_middle_moveDown_assert_getMoves
from test.state.moves.master._1x1.middle.top_left_moveUp_assert import getMoves as _1x1_middle_left_moveUp_assert_getMoves
from test.state.moves.master._1x1.middle.top_left_moveRight_assert import getMoves as _1x1_middle_left_moveRight_assert_getMoves
from test.state.moves.master._1x1.middle.top_left_moveDown_assert import getMoves as _1x1_middle_left_moveDown_assert_getMoves
from test.state.moves.master._1x1.middle.top_right_moveUp_assert import getMoves as _1x1_middle_right_moveUp_assert_getMoves
from test.state.moves.master._1x1.middle.top_right_moveLeft_assert import getMoves as _1x1_middle_right_moveLeft_assert_getMoves
from test.state.moves.master._1x1.middle.top_right_moveDown_assert import getMoves as _1x1_middle_right_moveDown_assert_getMoves
